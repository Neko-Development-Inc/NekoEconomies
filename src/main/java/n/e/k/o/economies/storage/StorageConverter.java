...
public class StorageConverter
{
    ...
    public static Object doConversion(Config.Settings.Storage storage, IStorage fromStorage, NekoEconomies nekoEconomies, Config config, Logger logger)
    {
        String from = storage.converter.from;
        String to = storage.converter.to;
        switch (from) {
            case "mysql": {
                switch (to) {
                    ...
                    case "flatfile": {
                        ...
                        FlatFileStorage toStorage = new FlatFileStorage(nekoEconomies, config, logger);
            ...
            case "flatfile": {
                switch (to) {
                    ...
                    case "mysql": {
                        ...
                        MysqlStorage toStorage = new MysqlStorage(nekoEconomies, config, logger);
                        if (!toStorage.init())
